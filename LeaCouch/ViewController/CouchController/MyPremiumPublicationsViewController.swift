//
//  MyPremiumPublicationsViewController.swift
//  LeaCouch
//
...
class MyPremiumPublicationsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {

    @IBOutlet weak var premiumPublicationTable: UITableView!
    

    var premiumPublicationArray = [Publicationd]()
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return premiumPublicationArray.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let acell = tableView.dequeueReusableCell(withIdentifier: "Cell") as? PremiumPublicationsTableViewCell else {
